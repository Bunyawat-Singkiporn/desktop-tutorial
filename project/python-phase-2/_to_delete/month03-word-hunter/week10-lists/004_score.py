# ============================================================
# Week 10 - WORD HUNTER (Word Bank + Levels)   (เฉลย)
...
while running:
    ...
    if not stage_over:
        if win:
            score += len(word) + lives * 2      # คำยาว + ชีวิตเหลือ = คะแนน
            stage_over = True
        elif lives <= 0:
            stage_over = True
    ...
    screen.blit(font_sml.render(f"คะแนน {score}", True, "lightgreen"), (40, 58))
