# ============================================================
# Week 7 - เช็คพอยต์ 2 : นับถอยหลัง + แถบเวลา
# แนวคิด: get_ticks(), นับถอยหลัง, แถบเวลา, หมดเวลา = ผิด, โบนัสความเร็ว
# รัน: python quiz.py
            ...
            # ----- โชว์เฉลย : Space ไปต่อ -----
                ...
                if event.key == pygame.K_SPACE:
                    ...
                    if index >= len(questions):
                        ...
                        question_start = pygame.time.get_ticks()   # เริ่มจับเวลาข้อใหม่
